...
/* Theme-aware iOS-style QWERTY keyboard. Presentational; wire onKey etc. */
...
export function Keyboard({ onKey, onBackspace, onReturn }) {
  ...
  return (
    <div style={{ background: "var(--fomo-keyboard-bg)", padding: "8px 3px 4px" }}>
      ...
      <div style={{ position: "relative", height: "18px" }}>
        <div style={{ position: "absolute", bottom: "1px", left: "50%", transform: "translateX(-50%)", width: "134px", height: "5px", borderRadius: "3px", background: "var(--fomo-home-indicator)" }} />
      </div>
    </div>
  );
}
